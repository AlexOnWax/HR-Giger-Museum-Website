...
<head>
    ...
    <script src="JS/script_bouton_deconnection_dashboard.js" defer></script>
</head>
<body>
    <header>
...
<div class="log"><div><a href='logout.php'>Log Out </a><?php echo "<p>".$nom."</p>"; ?></div></div>
            ...
            $sql="SELECT email, date FROM Mail LIMIT 10 ";
            $conn = $dbnl->query($sql);
              ...
              while($row = $conn->fetch(PDO::FETCH_ASSOC)) : ?>
                        ...
                        <td><input type="checkbox" name="mail_suppr"><svg width="31" height="31" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
